...
namespace MassRoverApi.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        {
            new Product { Id = 1, Name = "Lithim L2", ModifiedDate =
                DateTime.UtcNow.AddDays(-2) },
            new Product { Id = 2, Name = "SNU 61" }
        };

        /// <summary>
        /// Gets lists of all Products
        /// </summary>
        /// <returns>List of Products</returns>
        /// <response code="200">Liist of products</response>
        /// 
        [HttpGet]
        ...
        /// <summary>Replaces a product</summary>
        ...
        [ProducesResponseType(typeof(EntityNotFoundErrorMessage), 400)]
        ...
        /// <param name="id">Product id</param>
        /// <returns></returns>
        /// <respose code="204">No content</respose>
        /// <response code="404">No Product fouund for the specified id</response>
        [HttpDelete("{id}")]
        [ProducesResponseType(204)]
